...
| 2018.02.28- | [테스트 주도 개발로 배우는 객체 지향 설계와 실천](https://github.com/iamkyu/auction-sniper) (사내) | 매주 수요일, 브라운백, 12명 | '테스트 주도 개발로 배우는 객체 지향 설계와 실천' 책을 바탕으로 좋은 설계에 대한 학습. 실제 코드 작성, 짝프로그래밍 위주의 진행 |

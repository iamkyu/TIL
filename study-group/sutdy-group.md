...
| 기간          | 주제                               | 방식                | 내용                                       |
| ----------- | -------------------------------- | ----------------- | ---------------------------------------- |
| 2020.02-2020.03 | 실무에 리액티브 스택을 활용하기 위해 팀원들과 스터디 | 매주 화요일 오프라인 / 각자 책 읽기/실습/토론 | [실전! 스프링 5를 활용한 리액티브 프로그래밍](https://book.naver.com/bookdb/book_detail.nhn?bid=15045543), [RxJava 리액티브 프로그래밍](https://book.naver.com/bookdb/book_detail.nhn?bid=14689555)를 활용 |

# 2019

| 기간          | 주제                               | 방식                | 내용                                       |
| ----------- | -------------------------------- | ----------------- | ---------------------------------------- |
| 2019.10.26-2019.10.27 | [44bits 워크숍: 도커, 깐 김에 배포까지](https://workshop.44bits.io/) | 14시간 | Docker 워크숍 |
| 2019.01.16-2019.05.22 | [SLiPP 스터디 - 개발 실무 디자인 패턴](https://www.slipp.net/wiki/pages/viewpage.action?pageId=30771279) | 격주 수요일 오프라인 | 객체지향설계 인사이트를 얻고자 디자인 패턴 스터디 시작 |

# 2018

| 기간          | 주제                               | 방식                | 내용                                       |
| ----------- | -------------------------------- | ----------------- | ---------------------------------------- |
| 2018.11.10-2018.12.01 | [개발자와 스타트업을 위한 AWS Basic](https://codesquad.kr/page/aws-basic.html) | 매주 토요일 오프라인 | 정호영 강사님의 AWS 이론, 실습 교육 |
...
| 2018.03.05-2018.06.01 | Deep Dive Domain (사내/팀내)         | 오프라인, 9명          | 도메인 전문가 양성을 위해 우리가 만들고 있는 서비스의 각 도메인에 대해 심도있게 파악하고 앞으로 해결해야 할 문제를 분석 |

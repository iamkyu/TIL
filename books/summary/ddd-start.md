...
- [DDD Start!](#ddd-start)
    ...
    - [6. 응용 서비스와 표현 영역](#6-응용-서비스와-표현-영역)
        - [응용서비스](#응용서비스)
            ...
            - [응용 서비스에 인터페이스를 구현해야 할까?](#응용-서비스에-인터페이스를-구현해야-할까)
        - [표현영역](#표현영역)
    - [7. 도메인 서비스](#7-도메인-서비스)
    - [8. 애그리거트 트랜잭션 관리](#8-애그리거트-트랜잭션-관리)
        - [선점 잠금(Pessimistic Lock)](#선점-잠금pessimistic-lock)
        - [비선점 잠금(Optimistic Lock)](#비선점-잠금optimistic-lock)
        - [오프라인 선점 잠금 (Passimistic Offline Lock)](#오프라인-선점-잠금-passimistic-offline-lock)
    - [9. 도메인 모델과 BOUNDED CONTEXT](#9-도메인-모델과-bounded-context)
        - [BOUNDED CONTEXT 통합/관계](#bounded-context-통합관계)
    - [10. 이벤트](#10-이벤트)
        - [이벤트](#이벤트)
        - [비동기 이벤트 처리](#비동기-이벤트-처리)
        - [이벤트 적용 시 고려사항](#이벤트-적용-시-고려사항)

...
- [ ] Professional 소프트웨어 개발. 스티브 맥코넬 저. 윤준호 외 1명 역. 인사이트. 2003.
...
- [x] 스프링 MVC 프로그래밍. 마틴 데니엄 외 4명 저. 김인희 역. 에이콘출판. 2013.
...
- [ ] 브루스 테이트의 세븐 랭귀지. 브루스 테이트 저. 임백준 역. 한빛미디어. 2015.
- [ ] Practical Vim. 드류 네일 저. 김용균 역. 인사이트. 2017.
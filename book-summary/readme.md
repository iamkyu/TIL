...
- [ ] 피플웨어. 톰 드마르코,티모시 리스터 공저. 박재호,이해영 공역. 인사이트. 2014.
- [ ] 린 소프트웨어 개발. 메리 포펜딕,톰 포펜딕 공저. 김정민 외3명 역. 인사이트. 2007.
- [ ] 맨먼스 미신.  프레더릭 브룩스 저. 강중빈 역. 인사이트. 2015.
...
- [ ] 네이버를 만든 기술, 읽으면서 배운다 자바편. 강경태 외 11명 저. 위키북스. 2015.
...
- [ ] 프로가 되기 위한 웹 기술 입문. 고모리 유스케 저. 김정환 역. 위키북스. 2012.
